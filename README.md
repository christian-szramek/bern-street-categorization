...
The goal of this tool is to automatically categorize OpenStreetMap street segements into predefined buckets and visualize them in a web application. It is part of a bachelor thesis and can process the cities Bern, Berlin, Weimar and Wichita Falls. 
...
1. Start the processing with the values according to gthe .env file:
```console
foo@bar:~$ ./process.sh
```
