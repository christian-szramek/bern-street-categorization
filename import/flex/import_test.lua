...
for _, entry in ipairs(infrastructure_types) do
    ...
    -- for testing
    create_tables_for_infrastructure_type('ignored', true, true, 'Ignored')
    create_tables_for_infrastructure_type('not_highway', true, true, 'Not highway') 
end

function osm2pgsql.process_node(object)
    if infrastructure_logic.is_highway(object.tags) then

        if infrastructure_logic.is_ignored(object.tags) then
            -- TODO: insert in ignored_nodes
        else
        ...
        -- TODO: insert in not_highway_nodes
    end
end
...
function osm2pgsql.process_way(object)
    if infrastructure_logic.is_highway(object.tags) then
        ...
        -- TODO: insert in not_highway_ways or not_highway_areas
    end
end
...
function osm2pgsql.process_relation(object)
    if infrastructure_logic.is_highway(object.tags) then
        if infrastructure_logic.is_ignored(object.tags) then
            -- TODO: insert into ignored_areas
        else
        ...
        -- TODO: insert into not_highway_areas
    end
end
